This is a great step. To make a GitHub project look professional—especially if your son or other software architects look at it—you need a solid `README.md` (the "cover page"). 
...
Here is a template you can use. You can copy this directly into a file named `README.md` in your project root.
